 ...
 */
public class AllInvolvedRoleTableModel extends AbstractTableModel {
    ...
    public AllInvolvedRoleTableModel(List <InvolvedRole> entity) {
...
@Override
    public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
        InvolvedRole aRow = entityList.get(rowIndex);
            switch (columnIndex) {
            case 0:
