 ...
 */
public class AllProjectRoleTableModel extends AbstractTableModel {
    ...
    public AllProjectRoleTableModel(List <ProjectRole> entity) {
...
@Override
    public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
        ProjectRole aRow = entityList.get(rowIndex);
            switch (columnIndex) {
            case 0:
