 ...
 */
public class AllReferenceDialog extends javax.swing.JDialog {
     ...
     */
    public AllReferenceDialog(java.awt.Frame parent, List<ReferenceEntity> entities, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void runMain(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AllReferenceDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AllReferenceDialog dialog = new AllReferenceDialog(new javax.swing.JFrame(),null, true);
