 ...
 */
public class AllTechnologyTableModel extends AbstractTableModel {
    ...
    public AllTechnologyTableModel(List <Technology> entity) {
...
@Override
    public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
        Technology aRow = entityList.get(rowIndex);
            switch (columnIndex) {
            case 0:
