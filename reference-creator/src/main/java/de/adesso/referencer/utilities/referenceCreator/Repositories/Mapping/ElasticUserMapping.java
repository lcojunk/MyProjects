 ...
 */
public class ElasticUserMapping extends ElasticMapping{
     public static String typeName="el_user";  
    
    public static EFieldType makeEFieldType(Class c, Field f) {
        EFieldType fieldMapping=null;
        
        String fieldname=f.getName();
        if (fieldname.matches("person")) {
            ...
            return type;
        } else if (fieldname.matches("id")|| fieldname.matches("username")
                 ||fieldname.matches("pass")||    fieldname.matches("role")
                 ||fieldname.matches("group")) {
